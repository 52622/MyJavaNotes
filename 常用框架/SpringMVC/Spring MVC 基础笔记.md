...
![1538643225900](assets\1538643225900.png)

arg的方法

![1538643313362](assets\1538643313362.png)

先取出注解类型的变量

![1538643359094](assets\1538643359094.png)

如果没有注解类型的

![1538643412499](assets\1538643412499.png)

![1538643458214](assets\1538643458214.png)

![1538643537159](assets\1538643537159.png)

![1538643551505](assets\1538643551505.png)
...
![1538644906510](assets\1538644906510.png)

处理结果

![1538644974530](assets\1538644974530.png)

处理异常和渲染视图

![1538645054816](assets\1538645054816.png)

![1538645117906](assets\1538645117906.png)

输出视图

![1538645226160](assets\1538645226160.png)

把模型暴露到属性中

![1538645284592](assets\1538645284592.png)

遍历Map，把值放入到请求域

![1538645340641](assets\1538645340641.png)

入参的model就是

![1538645584782](assets\1538645584782.png)
...
![1538645886752](assets\1538645886752.png)



![1538645951102](assets\1538645951102.png)

放入请求域的方法：

![1538646038804](assets\1538646038804.png)
...
![1538663254884](assets\1538663254884.png)
...
![1538704010280](assets\1538704010280.png)

处理方法，并渲染

![1538704098347](assets\1538704098347.png)



生成一个视图对象，并调用对应视图对象的渲染方法

![1538704162520](assets\1538704162520.png)

这里获得的View中的URL就是最终的物理视图路径

![1538704483856](assets\1538704483856.png)

把model的数据绑定到视图中

![1538704222220](assets\1538704222220.png)

默认使用InternalResourceView(如果有加入JSTL的包，会使用jstlView)

![1538704247040](assets\1538704247040.png)

转发请求

![1538704281847](assets\1538704281847.png)
...
![1538719417307](assets\1538719417307.png)
...
![1538789072203](assets\1538789072203.png)

转换器，用于从页面传入的类型和实体类型不一致的时候，进行数据类型转换

ConversionService

![1538790527633](assets\1538790527633.png)
